...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        renderRecommendations(movie, movies, refs, currentUser);
...
function renderRecommendations(movie, movies, refs, user) {
    const recommendations = MovieService.getRecommendationsForMovie(movies, movie, 6);
